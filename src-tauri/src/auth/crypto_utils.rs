...
pub fn derive_key(password: &str, salt: &[u8], params: &Argon2ParamsConfig) -> Result<crate::secmem::LockedBuffer> {
    let mut key = crate::secmem::LockedBuffer::new(32);
...
pub fn derive_metadata_mac_key(master_key: &[u8]) -> Result<crate::secmem::LockedBuffer> {
    let hk = Hkdf::<Sha256>::new(None, master_key);
    let mut out = crate::secmem::LockedBuffer::new(32);
    hk.expand(b"pulsar:meta", out.as_mut_slice())
