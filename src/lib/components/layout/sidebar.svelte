...
<SidebarRoot collapsible="none" class="app-sidebar bg-sidebar relative backdrop-blur">
  ...
  <SidebarContent class="flex flex-1 flex-col gap-2 px-2 pb-6">
        ...
        <SidebarMenu class="gap-1">
          <SidebarMenuItem>
            <SidebarMenuButton
              ...
              class="text-sidebar-foreground hover:bg-sidebar-border/30 data-[active=true]:bg-sidebar-border/50 h-[46px] w-full cursor-pointer justify-start rounded-[5px] pl-[12px] transition"
              onclick={handleShowAll}
            >
              <div
                class="flex h-[32px] w-[32px] shrink-0 items-center justify-center rounded-md bg-[color-mix(in_oklch,var(--tag-color)_15%,transparent)]"
              >
                <Globe size="14" />
              </div>
              ...
              {#if totalItemCount > 0}
                <span
                  class="bg-sidebar-foreground/10 mr-[8px] ml-auto flex h-[20px] items-center justify-center rounded-full px-3 text-sm"
                >
                  {totalItemCount}
                </span>
              {/if}
    ...
    <SidebarGroup class="w-full">
      <div class="relative z-10 mb-2 flex h-[24px] items-center justify-between pr-[8px] pl-[12px]">
        <span class="text-muted-foreground text-xs leading-none font-bold tracking-wider"
          >VAULT</span
        >
        <button
              ...
              <ContextMenu>
                <ContextMenuTrigger>
                  <SidebarMenuButton
                    ...
                    class="group text-sidebar-foreground hover:bg-sidebar-border/30 data-[active=true]:bg-sidebar-border/50 h-[50px] w-full cursor-pointer justify-start rounded-[5px] pl-[12px] transition"
                  ...
                  >
                    ...
                    <span class="ml-0 truncate font-medium">{button.text}</span>
    ...
    <SidebarMenu class="items-center">
      <SidebarMenuItem class="w-full cursor-pointer">
        <SidebarMenuButton
          ...
          class="text-sidebar-foreground hover:bg-sidebar-border/30 h-[46px] w-full cursor-pointer justify-start rounded-[5px] pl-[12px] transition"
        >
          {#snippet child({ props })}
