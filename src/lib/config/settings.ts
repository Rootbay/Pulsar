...
export const defaultPasswordPresets: PasswordPreset[] = [
    { name: 'Recommended 20', length: 20, charSet: 'All', strength: 98, settings: { uppercase: true, lowercase: true, digits: true, symbols: true, ambiguous: false, similar: false, pronounceable: false } },
    { name: 'Banking Safe', length: 12, charSet: 'Alphanumeric', strength: 85, settings: { uppercase: true, lowercase: true, digits: true, symbols: false, ambiguous: false, similar: false, pronounceable: false } },
    { name: 'Ultra Secure', length: 32, charSet: 'All + Extended', strength: 99, settings: { uppercase: true, lowercase: true, digits: true, symbols: true, ambiguous: false, similar: false, pronounceable: false } }
];
...
export const defaultSiteRules: SiteRule[] = [
    { url: 'banking.example.com', length: 12, type: 'Letters + Numbers', desc: 'Banking sites typically require letters and numbers only', settings: { uppercase: true, lowercase: true, digits: true, symbols: false, ambiguous: false, similar: false, pronounceable: false } },
    { url: 'social.example.com', length: 20, type: 'All characters', desc: 'Social media sites allow complex passwords', settings: { uppercase: true, lowercase: true, digits: true, symbols: true, ambiguous: false, similar: false, pronounceable: false } },
    { url: 'work.example.com', length: 14, type: 'Letters + Numbers + Basic symbols', desc: 'Corporate policies often limit symbol types', settings: { uppercase: true, lowercase: true, digits: true, symbols: true, ambiguous: false, similar: false, pronounceable: false } }
];