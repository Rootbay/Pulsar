...
export function createDatabaseStore<T>(
    ...
    async function load() {
        try {
            ...
            // Vault is likely locked or db not ready. 
            // We silent fail here, expecting the UI to trigger a reload when vault unlocks.
    ...
    async function save() {
        ...
        try {
            // Tauri maps camelCase JS args to snake_case Rust args
